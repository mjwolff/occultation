...
pro test_osse_construct_pathlength
  ...
  print, format = '(A,F10.1)', '  Total path km (expect > 0): ', total(seg_lengths)/1000.d
  print, ''
  ...
  ; ------------------------------------------------------------------
  impact_target1 = R + 98.5d3
  sin_alpha1 = impact_target1 / (R + 400.0d3)
