...
pro test_osse_find_shell_intersection_3d
  ...
  osse_find_shell_intersection_3d, sat_pos, sun_dir, R+50.0d3, R+60.0d3, isect
  print, format = '(A,I2)',   '  intersects (expect 1):         ', isect.intersects
  print, format = '(A,F8.1)', '  path_length km (expect 20.0):  ', isect.path_length/1000.d
  print, format = '(A,F8.1)', '  s_entry km (expect 340.0):     ', isect.s_entry/1000.d
  print, ''
  ...
  osse_find_shell_intersection_3d, sat_pos, sun_dir_out, R+50.0d3, R+60.0d3, isect
  ...
  sat_pos_t = [0.0d, 0.0d, R + 400.0d3]
  sun_dir_t  = [1.0d, 0.0d, 0.0d]
  osse_find_shell_intersection_3d, sat_pos_t, sun_dir_t, R+390.0d3, R+400.0d3, isect
  print, format = '(A,I2)',    '  intersects:                   ', isect.intersects
  print, format = '(A,E12.4)', '  discriminant_outer (near 0):  ', isect.discriminant_outer
  print, format = '(A,F8.3)',  '  path_length km (expect 0):    ', isect.path_length/1000.d
  print, ''
  ...
  sat_pos_c2 = [0.0d, 0.0d, R + 55.0d3]
  sun_dir_c2  = [1.0d, 0.0d, 0.0d]
  osse_find_shell_intersection_3d, sat_pos_c2, sun_dir_c2, R+50.0d3, R+60.0d3, isect
  print, format = '(A,I2)',   '  intersects (expect 1):         ', isect.intersects
  print, format = '(A,F8.1)', '  s_entry km (expect 0.0):       ', isect.s_entry/1000.d
  print, format = '(A,F8.1)', '  path_length km (expect ~185.9):', isect.path_length/1000.d
  print, ''
  ...
  sat_pos_c4 = [R + 45.0d3, 0.0d, 0.0d]
  sun_dir_c4  = [0.0d, 1.0d, 0.0d]
  osse_find_shell_intersection_3d, sat_pos_c4, sun_dir_c4, R+50.0d3, R+60.0d3, isect
  print, format = '(A,I2)',   '  intersects (expect 1):         ', isect.intersects
  print, format = '(A,F8.1)', '  s_entry km (expect ~184.9):    ', isect.s_entry/1000.d
  print, format = '(A,F8.1)', '  s_exit km  (expect ~319.6):    ', isect.s_exit/1000.d
  print, format = '(A,F8.1)', '  path_length km (expect ~134.7):', isect.path_length/1000.d
  print, ''
  ...
  sat_pos_c5 = [R + 55.0d3, 0.0d, 0.0d]
  sun_dir_c5  = [1.0d, 0.0d, 0.0d]
  osse_find_shell_intersection_3d, sat_pos_c5, sun_dir_c5, R+50.0d3, R+60.0d3, isect
  print, format = '(A,I2)',   '  intersects (expect 1):         ', isect.intersects
  print, format = '(A,F8.1)', '  s_entry km (expect 0.0):       ', isect.s_entry/1000.d
  print, format = '(A,F8.1)', '  path_length km (expect 5.0):   ', isect.path_length/1000.d
  print, ''
