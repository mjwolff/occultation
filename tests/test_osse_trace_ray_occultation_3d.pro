...
pro test_osse_trace_ray_occultation_3d
  ...
  osse_trace_ray_occultation_3d, sat_pos, sun_dir, tang_alt, isects, n_int, params = params
  print, format = '(A,F8.1)', '  Tangent alt km (expect <0): ', tang_alt/1000.d
  print, format = '(A,I4)',   '  n_intersect (expect 0):     ', n_int
  print, ''
  ...
  osse_trace_ray_occultation_3d, sat_pos, sun_dir, tang_alt, isects, n_int, params = params
  print, format = '(A,F8.2)', '  Tangent alt km (expect ~50.5): ', tang_alt/1000.d
  ...
  print, format = '(A,F10.2)', '  tang_alt from trace (m):    ', tang_alt
  print, format = '(A,F10.2)', '  altitude from latlon (m):   ', res.altitude
  print, format = '(A,F10.4)', '  |difference| m (expect <10):', abs(tang_alt - res.altitude)
  print, ''
  ...
  sat_pos = [R + 80.0d3, 0.0d, 0.0d]
  sun_dir = [0.0d, 1.0d, 0.0d]
  osse_trace_ray_occultation_3d, sat_pos, sun_dir, tang_alt, isects, n_int, params = params
  print, format = '(A,F8.1)', '  Tangent alt km (expect 80.0): ', tang_alt/1000.d
  ...
  sat_pos = [R + 100.0d3, 0.0d, 0.0d]
  sun_dir = [0.0d, 1.0d, 0.0d]
  osse_trace_ray_occultation_3d, sat_pos, sun_dir, tang_alt, isects, n_int, params = params
  print, format = '(A,F8.1)', '  Tangent alt km (expect 100.0): ', tang_alt/1000.d
  print, format = '(A,I4)',   '  n_intersect (expect 0):        ', n_int
  print, ''
