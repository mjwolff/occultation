...
pro test_osse_calculate_transmittance
  ...
  sat_pos = [r_mars + 400.0d3, 0.0d0, 0.0d0]
  r_tang  = r_mars + 50.5d3
  sin_a   = r_tang / (r_mars + 400.0d3)
  ...
  osse_trace_ray_occultation_3d, sat_pos, sun_dir, tang_alt, intersections, n_int, $
    params = params
  print, format = '(A,F6.1,A,I3,A)', 'Geometry: tang_alt=', tang_alt / 1000.d, $
  ...
  osse_trace_ray_occultation_3d, sat_pos, sun_dir_out, tang_alt_out, isects_out, n_int_out, $
    params = params
  print, format = '(A,F6.1,A,I3,A)', 'Outward ray: tang_alt=', tang_alt_out / 1000.d, $
  ...
  ; With h_conrath=1e9, N ~= N_ref at all points.
  ...
  t_computed   = osse_calculate_transmittance(sat_pos, sun_dir, intersections, n_int, $
    sigma = sigma_test, n_ref = n_ref_test, h_conrath = 1.0d9, $
  ...
  r_tang_deep  = r_mars + 10.5d3
  sin_b        = r_tang_deep / (r_mars + 400.0d3)
  ...
  print, format = '(A,F6.1,A,I3,A)', 'Deep ray:    tang_alt=', tang_alt_deep / 1000.d, $
